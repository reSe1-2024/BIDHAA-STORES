            ...
            <?php if ($result->num_rows > 0): ?>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <div class="product-card">
                        <img src="img/products (1).png"  alt="<?= htmlspecialchars($row['name']); ?>" class="product-img">
        ...
        <?php else: ?>
            ...
            <?php foreach ($_SESSION['cart'] as $item): ?>
                <?php if (isset($cart_items[$item])): ?>
                    <p>
                        <?= htmlspecialchars($cart_items[$item]['name']); ?>
                        - Ksh <?= number_format($cart_items[$item]['price'], 2); ?>
                    </p>
                <?php endif; ?>
            <?php endforeach; ?>
